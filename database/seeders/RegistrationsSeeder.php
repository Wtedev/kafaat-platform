...
class RegistrationsSeeder extends Seeder
{
    ...
    {
        return [
            ['name' => 'فهد الدوسري', 'email' => 'portal.user01@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'نوف العتيبي', 'email' => 'portal.user02@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'سلمان الغامدي', 'email' => 'portal.user03@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'هند القحطاني', 'email' => 'portal.user04@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'عمر الزهراني', 'email' => 'portal.user05@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'لينا الشمري', 'email' => 'portal.user06@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'تركي المالكي', 'email' => 'portal.user07@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'دانة الحربي', 'email' => 'portal.user08@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'ماجد السبيعي', 'email' => 'portal.user09@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'أمل الرشيد', 'email' => 'portal.user10@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'خالد بن سعيد', 'email' => 'portal.user11@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'مها العنزي', 'email' => 'portal.user12@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'ياسر الفيفي', 'email' => 'portal.user13@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'شهد البقمي', 'email' => 'portal.user14@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'بندر العمري', 'email' => 'portal.user15@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'رنا الدخيل', 'email' => 'portal.user16@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'سعد المطيري', 'email' => 'portal.user17@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'هيفاء السهلي', 'email' => 'portal.user18@kafaat.org.sa', 'role_type' => 'beneficiary', 'spatie_role' => 'beneficiary'],
            ['name' => 'نورة المطيري', 'email' => 'portal.user19@kafaat.org.sa', 'role_type' => 'volunteer', 'spatie_role' => 'volunteer'],
            ['name' => 'ريم الشهري', 'email' => 'portal.user20@kafaat.org.sa', 'role_type' => 'volunteer', 'spatie_role' => 'volunteer'],
            ['name' => 'لطيفة العتيبي', 'email' => 'portal.user21@kafaat.org.sa', 'role_type' => 'volunteer', 'spatie_role' => 'volunteer'],
            ['name' => 'عادل القرني', 'email' => 'portal.user22@kafaat.org.sa', 'role_type' => 'volunteer', 'spatie_role' => 'volunteer'],
            ['name' => 'منى الزهراني', 'email' => 'portal.user23@kafaat.org.sa', 'role_type' => 'volunteer', 'spatie_role' => 'volunteer'],
            ['name' => 'فيصل الشهري', 'email' => 'portal.user24@kafaat.org.sa', 'role_type' => 'volunteer', 'spatie_role' => 'volunteer'],
            ['name' => 'غادة العنزي', 'email' => 'portal.user25@kafaat.org.sa', 'role_type' => 'volunteer', 'spatie_role' => 'volunteer'],
        ];
    }
