...
<section class="mb-6 flex flex-wrap items-start justify-between gap-3 text-right">
    ...
    <a href="{{ route('portal.notifications.settings') }}" class="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-600 shadow-sm transition hover:text-[#253B5B]">
