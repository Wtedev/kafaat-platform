...
<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    'TrainingProgram' => config('brand.classes.badge_secondary'),
    'LearningPath' => config('brand.classes.badge_primary'),
    'VolunteerOpportunity' => config('brand.classes.badge_accent'),
    ...
    <div class="flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
        ...
        <div class="flex items-start justify-between gap-2">
            ...
            <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-brand-light text-brand" aria-hidden="true">
