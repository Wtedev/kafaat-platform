...
<x-portal.settings-shell title="الإعدادات" subtitle="إدارة الحساب والتنبيهات والخصوصية." back-route="portal.dashboard" back-label="البوابة">
    <x-portal.settings-card>
        <p class="border-b border-[#c5d4e4]/70 bg-[#e9eff6] px-4 py-2.5 text-[11px] font-semibold text-[#335483] sm:px-5">الحساب</p>
        ...
        <p class="border-y border-[#c5d4e4]/70 bg-[#e9eff6] px-4 py-2.5 text-[11px] font-semibold text-[#335483] sm:px-5">التنبيهات</p>
        ...
        <p class="border-y border-[#c5d4e4]/70 bg-[#e9eff6] px-4 py-2.5 text-[11px] font-semibold text-[#335483] sm:px-5">القانونية</p>
