...
{{--
  When separated=true, cancel parent divide-y hairline (!border-t-0) and draw only a thick rule.
--}}
<div @class([
    $separated ? '!border-t-0' : null,
])>
    @if ($separated)
        <div class="mt-2 border-t-2 border-gray-200" aria-hidden="true"></div>
    @endif
