                    ...
                    <div class="relative w-full max-w-md">
                        ...
                        <div class="relative bg-white rounded-3xl shadow-2xl p-7 space-y-4 border border-white">
                            ...
                            <div class="flex items-center justify-between pb-4 border-b border-gray-100">
                                <div class="w-11 h-11 rounded-2xl flex items-center justify-center flex-shrink-0" style="background:#EAF2FA">
                                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="#253B5B">
                            ...
                            <a href="{{ route('public.paths.index') }}" class="flex items-center gap-4 p-4 rounded-2xl border border-gray-100 hover:border-[#c5ddef] hover:bg-[#F8FBFE] transition-all group">
                                ...
                                <svg class="w-4 h-4 rotate-180 opacity-40 group-hover:opacity-100 transition-opacity" style="color:#253B5B" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="{{ route('public.volunteering.index') }}" class="flex items-center gap-4 p-4 rounded-2xl border border-gray-100 hover:border-green-200 hover:bg-green-50/50 transition-all group">
                                ...
                                <svg class="w-4 h-4 rotate-180 opacity-40 group-hover:opacity-100 transition-opacity text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                            </a>
                        </div>
                        ...
                        <div class="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-lg px-4 py-3 flex items-center gap-3 border border-gray-50">
                            <div class="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0" style="background:#EAF2FA">
                                <svg class="w-4 h-4" style="color:#253B5B" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="relative">
                        <div class="flex items-center justify-end gap-3 mb-6">
                            ...
                            <div class="w-14 h-14 rounded-2xl flex items-center justify-center shadow-sm" style="background: linear-gradient(145deg, #EAF2FA, #DCE8F5)">
                                <svg class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="#253B5B">
                ...
                <a href="{{ route('public.news.show', $item->slug) }}" class="group bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden block">
                    ...
                    <div class="p-6 text-right">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            @endif
                            @if ($item->category)
                            <span class="text-xs font-medium px-3 py-1 rounded-xl" style="background:#EAF2FA; color:#253B5B">{{ $item->category }}</span>
                            @endif
                        </div>
