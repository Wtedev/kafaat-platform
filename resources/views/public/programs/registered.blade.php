...
<div class="mx-auto max-w-2xl">
    <div class="reg-success overflow-hidden rounded-[1.75rem] border border-[#c5d4e4]/60 bg-white shadow-[0_20px_60px_-28px_rgba(51,84,131,0.35)]">
        ...
        <div class="space-y-5 border-t border-gray-100 px-6 py-7 sm:px-10">
            @if ($pending)
                <div class="rounded-2xl border border-amber-200/80 bg-amber-50/80 px-5 py-4 text-center">
                    <p class="text-sm font-semibold text-amber-900">الخطوة التالية</p>
                    <p class="mx-auto mt-1.5 max-w-md text-sm leading-relaxed text-amber-800/90">
                    ...
                    <a href="{{ $success['notifications_settings_url'] }}"
                       class="mt-4 inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-[#335483] shadow-sm ring-1 ring-[#c5d4e4]/70 transition hover:bg-[#e9eff6]">
                        إعدادات التنبيهات
            ...
            @if ($approved && $whatsappUrl)
                <div class="rounded-2xl border border-[#25D366]/30 bg-[#25D366]/5 px-5 py-4 text-center">
                    <p class="text-sm font-semibold text-gray-900">مجموعة واتساب البرنامج</p>
                    <p class="mx-auto mt-1 max-w-md text-sm text-gray-500">انضم للمجموعة المناسبة لمتابعة التحديثات والتواصل.</p>
                    <a href="{{ $whatsappUrl }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="mx-auto mt-4 inline-flex w-full max-w-sm items-center justify-center gap-2 rounded-2xl px-5 py-3.5 text-sm font-semibold text-white shadow-md transition hover:-translate-y-0.5 hover:shadow-lg"
