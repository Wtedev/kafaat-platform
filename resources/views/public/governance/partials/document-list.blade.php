...
<div class="py-16 text-center">
    ...
    <h3 class="mb-1 text-base font-semibold" style="color:#374151">{{ $emptyTitle }}</h3>
...
<div class="space-y-5">
    @foreach ($categoryOrder as $categoryKey)
        ...
        <section>
            <h3 class="mb-2.5 text-sm font-bold text-right" style="color:#111827">
                ...
                <div class="rounded-xl border border-gray-100 bg-white px-3.5 py-2.5 shadow-sm text-right">
                    <div class="flex items-center justify-between gap-3">
                        <div class="min-w-0 flex-1">
                            <h4 class="text-sm font-semibold leading-snug" style="color:#111827">{{ $doc->title }}</h4>
