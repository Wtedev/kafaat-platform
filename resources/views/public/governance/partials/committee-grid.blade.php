...
<div class="py-20 text-center">
    ...
    <h3 class="mb-1 text-lg font-semibold">لم يتم إضافة اللجان الدائمة بعد</h3>
...
<div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
    ...
    <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm text-right">
        <h3 class="text-base font-bold">{{ $committee->name }}</h3>
        ...
        <ul class="space-y-2">
            ...
            <li class="flex items-center gap-2.5 rounded-xl bg-[#F8FAFC] px-3.5 py-2.5 text-sm font-medium" style="color:var(--brand-body)">
