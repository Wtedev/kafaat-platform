...
@section('meta_description', 'سياسة الخصوصية لمنصة كفاءات: كيف نجمع بياناتك ونستخدمها ونحميها، وحقوقك تجاه معلوماتك الشخصية.')
...
<div class="max-w-3xl mx-auto text-right">
    ...
    <div class="mb-10">
        <p class="text-sm font-semibold uppercase tracking-widest mb-2" style="color:#3CB878">الخصوصية والحماية</p>
    ...
    <div class="space-y-8 leading-relaxed" style="color:#374151">
        ...
        <section>
            ...
            <p>
                ...
                التي نجمعها وكيفية استخدامها وحمايتها عند استخدامك للمنصة وخدماتها.
            </p>
        </section>
        ...
        <section>
            ...
            <ul class="list-disc list-inside space-y-2">
                <li>تقديم خدمات المنصة وإدارة حسابك وتسجيلاتك.</li>
        ...
        <section>
            ...
            <p>
                قد نحدّث هذه السياسة من وقت لآخر، وسيُعلن عن أي تغييرات جوهرية عبر المنصة. استمرارك في
                استخدام المنصة بعد التحديث يعني موافقتك على السياسة المعدّلة.
            </p>
        </section>
