...
<div class="max-w-3xl mx-auto text-right">
    ...
    <div class="mb-10">
        ...
        <h1 class="text-3xl sm:text-4xl font-bold mb-3">الشروط والأحكام</h1>
        <p class="text-sm" style="color:#9CA3AF">آخر تحديث: {{ ar_date(now(), 'MMMM y') }}</p>
    </div>

    <div class="space-y-8 leading-relaxed" style="color:var(--brand-body)">

        <section>
            <h2 class="text-xl font-bold mb-3">قبول الشروط</h2>
            <p>
        ...
        <section>
            <h2 class="text-xl font-bold mb-3">استخدام الحساب</h2>
        ...
        <section>
            <h2 class="text-xl font-bold mb-3">التسجيل في البرامج والفرص</h2>
            <p>
        ...
        <section>
            <h2 class="text-xl font-bold mb-3">إخلاء المسؤولية</h2>
            <p>
        ...
        <section>
            <h2 class="text-xl font-bold mb-3">تعديل الشروط</h2>
            <p>
