...
@section('meta_description', 'الشروط والأحكام التي تحكم استخدام منصة كفاءات وخدماتها التدريبية والتطوعية.')
...
<div class="max-w-3xl mx-auto text-right">
    ...
    <div class="space-y-8 leading-relaxed" style="color:#374151">
        ...
        <section>
            ...
            <p>
                باستخدامك منصة كفاءات فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي
                منها، يُرجى عدم استخدام المنصة.
            </p>
        </section>
        ...
        <section>
            ...
            <ul class="list-disc list-inside space-y-2">
                ...
                <li>يُحظر استخدام المنصة لأي غرض غير مشروع أو مخالف للأنظمة.</li>
            </ul>
        </section>
        ...
        <section>
            ...
            <p>
                جميع المحتويات والمواد المنشورة على المنصة مملوكة لجمعية كفاءات أو مرخّصة لها، ولا يجوز إعادة
        ...
        <section>
            ...
            <p>
                تُقدَّم خدمات المنصة "كما هي"، وتسعى الجمعية لضمان دقة المحتوى واستمرارية الخدمة دون أن تتحمل
        ...
        <section>
            ...
            <p>
                تحتفظ الجمعية بحق تعديل هذه الشروط في أي وقت، ويسري التعديل فور نشره على المنصة.
            </p>
        </section>
