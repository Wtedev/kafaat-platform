        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center gap-14">
                ...
                <div class="w-full lg:w-1/2 reveal-fade" style="transition-delay:0.15s">
                    @php
                    $stratPillars = [
                    ['label' => 'تعظيم الأثر التنموي',      'bg' => 'rgba(30,184,144,0.08)',  'stroke' => '#1EB890', 'path' => 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6'],
                    ['label' => 'التحول الرقمي',             'bg' => 'rgba(59,130,246,0.08)',   'stroke' => '#3B82F6', 'path' => 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
                    ['label' => 'الاستدامة المالية',         'bg' => 'rgba(139,92,246,0.08)',  'stroke' => '#8B5CF6', 'path' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                    ['label' => 'تطوير رأس المال البشري',   'bg' => 'rgba(245,158,11,0.08)',  'stroke' => '#F59E0B', 'path' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z'],
                    ];
                    @endphp
