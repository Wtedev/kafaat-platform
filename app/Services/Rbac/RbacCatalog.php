...
final class RbacCatalog
{
    ...
    public static function domainPermissionNames(): array
    {
        return [
            ...
            'retention_policies.update_draft',
    ...
    public static function permissionLabelsAr(): array
    {
        $map = [
            ...
            'retention_policies.create' => 'إنشاء سياسات احتفاظ',
            'retention_policies.update_draft' => 'تعديل مسودات الاحتفاظ',
            ...
            'retention_runs.view' => 'عرض عمليات الاحتفاظ',
            'retention_runs.execute' => 'تنفيذ عمليات الاحتفاظ',
