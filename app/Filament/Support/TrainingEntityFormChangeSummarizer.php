...
class TrainingEntityFormChangeSummarizer
{
    ...
    private static function formatValue(string $key, mixed $value): string
    {
        ...
        return match ($key) {
            ...
            'publish_immediately', 'capacity_unlimited', 'auto_accept_registrations', 'notify_audience', 'is_linked_to_path', 'notify_on_publish', 'notify_milestones', 'notify_registrants_on_update' => static::boolLabel($value),
