...
final class TrainingEntityFormSupport
{
    ...
    {
        return [
            self::programDescriptionRichEditorField(),
    ...
    {
        return [self::advancedSettingsSection($hideWhenLinkedToPath)];
    }
    ...
    public static function advancedSettingsSection(
        ...
        $schema = self::registrationAdvancedSettingsFields(
            $capacityVisible,
    ...
    public static function advancedProgramSettingsSection(bool $forEdit = false, bool $hidePathLinkFields = false): Section
    {
        ...
        $pathLinkFields = $hidePathLinkFields ? [] : self::programPathLinkFields();

        return self::collapsibleAdvancedSettingsSection([
            ...$pathLinkFields,
            ...self::registrationAdvancedSettingsFields(
                $capacityVisible,
            ...
            ...self::entityAdvancedStaffBlock(
                ...
                $forEdit ? self::programStaffFieldsForEdit() : self::programStaffFieldsForCreate(),
                $staffVisible,
            ),
        ]);
    }
    ...
    public static function programAcceptanceConditionsSection(?Closure $visible = null): Section
    {
        $section = Section::make('شروط القبول')
            ...
            ->columns(1)
            ->schema(self::programAcceptanceConditionsFields());
    ...
    public static function programAcceptanceConditionsFields(): array
    {
        ...
        return [
            self::advancedSettingsToggle('auto_accept_registrations', 'قبول تلقائي')
                ->default(false)
                ->live()
            ...
            self::advancedSettingsToggle('acceptance_manual_review', 'قبول يدوي')
                ->default(false)
                ->live()
                ->dehydrated(false)
    ...
    {
        return [
            self::advancedSettingsToggle('is_linked_to_path', 'تابع لمسار تدريبي')
                ->default(false)
                ->live()
    ...
    {
        return self::collapsibleAdvancedSettingsSection([
            ...self::registrationAdvancedSettingsFields(null, includeProgramAudienceNotifications: false),
            self::advancedSettingsToggle('notify_on_publish', 'إشعارات المستفيدين')
                ->default(false),
            ...self::entityAdvancedStaffBlock(
                'المسؤولية',
                self::pathStaffSectionDescription(),
                $forEdit ? self::pathStaffFieldsForEdit() : self::pathStaffFieldsForCreate(),
            ),
        ]);
    }
    ...
    {
        return self::collapsibleAdvancedSettingsSection([
            self::advancedSettingsToggle('notify_audience_on_publish', 'إشعارات المستفيدين')
                ->default(true)
    ...
    public static function advancedVolunteerSettingsSection(): Section
    {
        return self::collapsibleAdvancedSettingsSection([
            ...
            self::advancedSettingsToggle('notify_on_publish', 'إشعارات المستفيدين')
                ->default(true),
            self::advancedSettingsToggle('notify_registrants_on_update', 'تنبيه المسجّلين')
                ->default(false),
            ...self::entityAdvancedStaffBlock(
                'مسؤولية الفرصة',
                'يُحدَّد منسق التطوع المسؤول عن إدارة الفرصة في لوحة الإدارة.',
                self::volunteerStaffFields(),
            ),
        ]);
    }

    /**
     * @param  array<int, Component|\Filament\Schemas\Components\Component>  $schema
     */
    ...
    public static function registrationAdvancedSettingsFields(
        ...
        $autoAccept = self::advancedSettingsToggle('auto_accept_registrations', 'قبول تلقائي')
            ->default(false);
    ...
    /**
     * @param  array<int, Component>  $staffFields
    ...
    public static function publicationSection(\BackedEnum $publishedStatus, bool $forEdit = false): Section
    {
        $section = Section::make('النشر')
            ->columns(1)
            ->schema(self::publicationInlineFields());

        if ($forEdit) {
            $section->visible(fn (?Model $record): bool => self::publishControlsVisibleForRecord(
                $record,
                $publishedStatus,
            ));
        }
    ...
    {
        $errors = self::validateProgramScheduleDates($data, $showRegistration);
    ...
    public static function programStaffSectionForCreate(): Section
    {
        return Section::make('مسؤولي البرنامج')
            ->description(self::programStaffSectionDescription())
            ->icon('heroicon-o-user-group')
            ->schema(self::programStaffFieldsForCreate());
    }
    ...
    public static function programStaffSectionForEdit(): Section
    {
        return Section::make('مسؤولي البرنامج')
            ...
            ->icon('heroicon-o-user-group')
            ->visible(fn (Get $get): bool => ! (bool) $get('is_linked_to_path'))
            ->schema(self::programStaffFieldsForEdit());
    }

    public static function staffSectionForCreate(): Section
    {
        return Section::make('المسؤولية')
            ->description(self::pathStaffSectionDescription())
            ->columns(1)
            ->schema(self::pathStaffFieldsForCreate());
    }
    ...
    public static function staffSectionForEdit(): Section
    {
        return Section::make('المسؤولية')
            ->description(self::pathStaffSectionDescription())
            ->columns(1)
            ->schema(self::pathStaffFieldsForEdit());
    }
