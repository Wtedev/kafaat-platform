...
use App\Filament\Resources\GeneralAssemblyMemberResource\Pages;
...
class GeneralAssemblyMemberResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'أعضاء الجمعية العمومية';

    protected static ?string $modelLabel = 'عضو';

    protected static ?string $pluralModelLabel = 'أعضاء الجمعية العمومية';
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('بيانات العضو')
                ...
                ->schema([
                    Hidden::make('group')
                        ->default(BoardMember::GROUP_GENERAL_ASSEMBLY),
                    ...
                    FileUpload::make('photo')
                        ...
                        ->image()
                        ->disk('public')
                        ->directory('governance/general-assembly-members')
                        ->visibility('public')
                        ->maxSize(4096)
    ...
    {
        return parent::getEloquentQuery()->where('group', BoardMember::GROUP_GENERAL_ASSEMBLY);
    }
